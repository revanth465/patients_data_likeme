 ...
 * @author venu
 */
public class TaskCondition extends javax.swing.JFrame {
...
ResultSet rs=null;
 ...
 Open_table();
     ...
     public void Open_table(){
       try {
           String sql="Select diag_id as 'Diagnosis ID',pat_id as 'Patient ID',diag_name as 'Diagnosis Name',diagnosis_track as 'Diagnosis Track',time_stamped as 'Time Stamped' from diagnosis ";
    ...
    private void initComponents() {
        ...
        dtrack = new javax.swing.JTextField();
        ...
        sym.setText("Diagnosis ID");

        patint_id.setText("Patient ID");

        sym_name.setText("Diagnosis Name");

        sym_track.setText("Diagnosis Track");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(65, 65, 65)
                        .addComponent(dtrack, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(151, 151, 151)
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGap(61, 61, 61)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(pid, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(dname, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(did, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(sym_track)
                    .addComponent(dtrack, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(91, 91, 91)
                .addComponent(jButton1)
    ...
    private void show_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_show_tableMouseClicked
        ...
        try{
            ...
            String sql="Select * from diagnosis where diag_id='"+Table_click+"' ";
            pst=mycon.prepareStatement(sql);
            rs=pst.executeQuery();

            if(rs.next())
            {
                String add1= rs.getString("diag_id");
                did.setText(add1);
                String add2= rs.getString("pat_id");
                pid.setText(add2);
                String add3= rs.getString("diag_name");
                dname.setText(add3);
                String add4= rs.getString("diagnosis_track");
                dtrack.setText(add4);
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        // TODO add your handling code here:
             ...
             String sql="insert into diagnosis(diag_id,pat_id,diagnosis_track,time_stamped,diag_name) values(?,?,?,now(),?)";
        try{
           pst=mycon.prepareStatement(sql);
            pst.setString(1,did.getText());
            pst.setString(2,pid.getText());
            pst.setString(3,dtrack.getText());
             pst.setString(4,dname.getText());
           pst.executeUpdate();
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try{
            ...
            String value2= pid.getText();
            //  String value3="'now()'";
            String value4= dtrack.getText();
              String value5= dname.getText();
            String sql=" update diagnosis set diag_name='"+value5+"',time_stamped=now(), diagnosis_track='"+value4+"' ,pat_id='"+value2+"' where diag_id='"+value1+"' ";
            pst=mycon.prepareStatement(sql);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
      ...
      //  String sql="delete from symptoms where sym_id=?";
        String value=did.getText();
        try{

 String sql="delete from diagnosis where diag_id='"+value+"' ";
pst=mycon.prepareStatement(sql);
 pst.execute();
 ...
 JOptionPane.showMessageDialog(null,"Deleted");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaskCondition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TaskCondition().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField dtrack;
